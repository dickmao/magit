...
#+texinfo_dir_title: Magit-Section: (magit2-section).
...
user options see [[info:magit2#Sections]].  This manual documents how you
...
and user options see [[info:magit2#Sections]].  This manual documents
...
- Macro: magit2-insert-section [name] (type &optional value hide) &rest body ::
...
- Macro: magit2-insert-section-body &rest body ::
...
- Function: magit2-wash-sequence function ::
...
- Function: magit2-section-ident-value value ::
...
- Function: magit2-section-lineage section ::
...
- Function: magit2-section-match condition &optional (section (magit2-current-section)) ::
...
- Macro: magit2-section-case &rest clauses ::
...
#  LocalWords:  alist eval featurep ident keymap magit2 ol
